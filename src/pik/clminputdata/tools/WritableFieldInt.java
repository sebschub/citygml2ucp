...
public class WritableFieldInt extends ArrayDouble implements NetCDFWritable {

	public String name, standard_name, long_name, units, grid_mapping;
	...
	public List<Dimension> addVariablesToNetCDFfile(NetcdfFileWriteable ncfile) {
		Variable var = ncfile.addVariable(name, DataType.INT, dimlist);
