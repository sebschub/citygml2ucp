...
//		conf.toNetCDFfile("/home/schubert/temp/test2.nc");
		...
		UrbanCLMConfiguration uclm = new UrbanCLMConfiguration(90., -180.,
				...
				51, 1, new double[] {-45, 0, 45, 90 }, new int[] { 22 }, new double[] {
						0.f, 5.f, 10.f, 15.f, 20.f, 25.f, 30.f, 35.f, 40.f,
						45.f, 50.f, 55.f, 60.f, 65.f, 70.f, 75.f, 80.f, 90.f,
						110.f, 140.f, 200.f, 300.f });
...
//		Proj4 testProjection = new Proj4("+init=epsg:3068", "+init=epsg:4326 +latlong");
////		testProjection.printSrcProjInfo();
////		testProjection.printDestProjInfo();
//		
//		ProjectionData dataTP = new ProjectionData(new double[][] {{31032.985 , 30874.249}}, new double[] {54.640});
//
